...
import { CampaignFilter, ApiResponse, CampaignResponse, CampaignInsert, Campaign } from '../Model/Campaign';
...
export class CampaignService {
    private api =
        'https://localhost:7236/api/CampaignContoller';
